/**
 * Formatos canônicos dos eventos de sync entre ecossistemas (comments ↔ NASA).
 * Mirror de `src/features/sync/lib/payloads.ts` do NASA.
 *
 ...
 * existem no seu schema; campos extras são ignorados (ex.: `phone`, que o
 * comments-app não tem mas o NASA tem).
 */
